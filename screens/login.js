...
export default class Login extends Component{
    ...
    handleSubmit = () => {
        ...
        if(userPresent(User))
        {
          this.setState({ showError: false, setError: false });
          this.props.navigation.navigate('DrawerNavigation');
        }else{
            this.setState({ setError: true, showError: true });
        }
    }
    ...
    render(){
        ...
        <Image source = {require('./../logo.png')} style={{
            ...
            { this.state.showError && <Text style={styles.errorText}>Username and password not valid {"\n"}</Text>}
            <Button
            title="Sign In"
            type='clear'
