...
export default class TripCreation extends Component{
  constructor(props){
    super(props)
  ...
  handleNewTripSubmit ({navigation}, trip, setError, setDateError) {
    ...
    return (
      <View style={{ flex: 1}}>
        ...
        <View style={{ flex: 0.8}}>
          ...
          { this.state.dateError && <Text style={styles.errorText}>{"\n"}Dates are not valid {"\n"}</Text>}
          </View>
        </View>
